...
OIMO.LinearConstraint.prototype = {
    ...
    preSolve:function(timeStep,invTimeStep){
        ...
        /*this.d00=(k[4]*k[8]-k[5]*k[7])*inv;
        this.d01=(k[2]*k[7]-k[1]*k[8])*inv;
        this.d02=(k[1]*k[5]-k[2]*k[4])*inv;
        this.d10=(k[5]*k[6]-k[3]*k[8])*inv;
        this.d11=(k[0]*k[8]-k[2]*k[6])*inv;
        this.d12=(k[2]*k[3]-k[0]*k[5])*inv;
        this.d20=(k[3]*k[7]-k[4]*k[6])*inv;
        this.d21=(k[1]*k[6]-k[0]*k[7])*inv;
        this.d22=(k[0]*k[4]-k[1]*k[3])*inv;
        */
