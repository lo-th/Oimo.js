...
OIMO.ContactConstraint.prototype.preSolve = function(timeStep,invTimeStep){
    ...
    this.i1e00=this.i1.e00;
    this.i1e01=this.i1.e01;
    this.i1e02=this.i1.e02;
    this.i1e10=this.i1.e10;
    this.i1e11=this.i1.e11;
    this.i1e12=this.i1.e12;
    this.i1e20=this.i1.e20;
    this.i1e21=this.i1.e21;
    this.i1e22=this.i1.e22;
    this.i2e00=this.i2.e00;
    this.i2e01=this.i2.e01;
    this.i2e02=this.i2.e02;
    this.i2e10=this.i2.e10;
    this.i2e11=this.i2.e11;
    this.i2e12=this.i2.e12;
    this.i2e20=this.i2.e20;
    this.i2e21=this.i2.e21;
    this.i2e22=this.i2.e22;
    var p1x=this.p1.x;
    var p1y=this.p1.y;
    var p1z=this.p1.z;
    var p2x=this.p2.x;
...
OIMO.HingeJoint = function(config,lowerAngleLimit,upperAngleLimit){
    ...
    this.localAngAxis2X=this.localAngAxis1X*arc.e00+this.localAngAxis1Y*arc.e01+this.localAngAxis1Z*arc.e02;
    this.localAngAxis2Y=this.localAngAxis1X*arc.e10+this.localAngAxis1Y*arc.e11+this.localAngAxis1Z*arc.e12;
    this.localAngAxis2Z=this.localAngAxis1X*arc.e20+this.localAngAxis1Y*arc.e21+this.localAngAxis1Z*arc.e22;
...
OIMO.HingeJoint.prototype.preSolve = function (timeStep,invTimeStep) {
    ...
    var axis1X=this.localAxis1X*tmpM.e00+this.localAxis1Y*tmpM.e01+this.localAxis1Z*tmpM.e02;
    var axis1Y=this.localAxis1X*tmpM.e10+this.localAxis1Y*tmpM.e11+this.localAxis1Z*tmpM.e12;
    var axis1Z=this.localAxis1X*tmpM.e20+this.localAxis1Y*tmpM.e21+this.localAxis1Z*tmpM.e22;
    var angAxis1X=this.localAngAxis1X*tmpM.e00+this.localAngAxis1Y*tmpM.e01+this.localAngAxis1Z*tmpM.e02;
    var angAxis1Y=this.localAngAxis1X*tmpM.e10+this.localAngAxis1Y*tmpM.e11+this.localAngAxis1Z*tmpM.e12;
    var angAxis1Z=this.localAngAxis1X*tmpM.e20+this.localAngAxis1Y*tmpM.e21+this.localAngAxis1Z*tmpM.e22;
    tmpM=this.body2.rotation;
    var axis2X=this.localAxis2X*tmpM.e00+this.localAxis2Y*tmpM.e01+this.localAxis2Z*tmpM.e02;
    var axis2Y=this.localAxis2X*tmpM.e10+this.localAxis2Y*tmpM.e11+this.localAxis2Z*tmpM.e12;
    var axis2Z=this.localAxis2X*tmpM.e20+this.localAxis2Y*tmpM.e21+this.localAxis2Z*tmpM.e22;
    var angAxis2X=this.localAngAxis2X*tmpM.e00+this.localAngAxis2Y*tmpM.e01+this.localAngAxis2Z*tmpM.e02;
    var angAxis2Y=this.localAngAxis2X*tmpM.e10+this.localAngAxis2Y*tmpM.e11+this.localAngAxis2Z*tmpM.e12;
    var angAxis2Z=this.localAngAxis2X*tmpM.e20+this.localAngAxis2Y*tmpM.e21+this.localAngAxis2Z*tmpM.e22;
...
OIMO.WheelJoint.prototype.preSolve = function (timeStep,invTimeStep) {
    ...
    this.updateAnchorPoints();
    tmpM=this.body1.rotation;
    var x1=this.localAxis1X*tmpM.e00+this.localAxis1Y*tmpM.e01+this.localAxis1Z*tmpM.e02;
    var y1=this.localAxis1X*tmpM.e10+this.localAxis1Y*tmpM.e11+this.localAxis1Z*tmpM.e12;
    var z1=this.localAxis1X*tmpM.e20+this.localAxis1Y*tmpM.e21+this.localAxis1Z*tmpM.e22;
    var angAxis1X=this.localAngAxis1X*tmpM.e00+this.localAngAxis1Y*tmpM.e01+this.localAngAxis1Z*tmpM.e02;
    var angAxis1Y=this.localAngAxis1X*tmpM.e10+this.localAngAxis1Y*tmpM.e11+this.localAngAxis1Z*tmpM.e12;
    var angAxis1Z=this.localAngAxis1X*tmpM.e20+this.localAngAxis1Y*tmpM.e21+this.localAngAxis1Z*tmpM.e22;
    tmpM=this.body2.rotation;
    var x2=this.localAxis2X*tmpM.e00+this.localAxis2Y*tmpM.e01+this.localAxis2Z*tmpM.e02;
    var y2=this.localAxis2X*tmpM.e10+this.localAxis2Y*tmpM.e11+this.localAxis2Z*tmpM.e12;
    var z2=this.localAxis2X*tmpM.e20+this.localAxis2Y*tmpM.e21+this.localAxis2Z*tmpM.e22;
    var angAxis2X=this.localAngAxis2X*tmpM.e00+this.localAngAxis2Y*tmpM.e01+this.localAngAxis2Z*tmpM.e02;
    var angAxis2Y=this.localAngAxis2X*tmpM.e10+this.localAngAxis2Y*tmpM.e11+this.localAngAxis2Z*tmpM.e12;
    var angAxis2Z=this.localAngAxis2X*tmpM.e20+this.localAngAxis2Y*tmpM.e21+this.localAngAxis2Z*tmpM.e22;
...
OIMO.Mat33.prototype = {
    ...
    invert: function(m){
        var det= m.e00*(m.e11*m.e22-m.e21*m.e12)+ m.e10*(m.e21*m.e02-m.e01*m.e22)+ m.e20*(m.e01*m.e12-m.e11*m.e02);
        if(det!=0)det=1/det;
    ...
    clone: function(){
        return new OIMO.Mat33(this.e00,this.e01,this.e02,this.e10,this.e11,this.e12,this.e20,this.e21,this.e22);
    },
    toString: function(){
        var text=
